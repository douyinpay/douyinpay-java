...
public class AutoSm2Verifier extends Sm2Verifier {
    private final CertificateProvider certificateProvider;

    public AutoSm2Verifier(CertificateProvider certificateProvider) {
    ...
    public boolean verifyPlatformSign(String plainText, X509Certificate platformCertificate, String sign, String serialNumber) throws DouyinpayException {
        ...
        return verifyPlatformCertificate(plainText, cert, sign);
    }
}
