package com.douyinpay.api.payments.nativepay;
...
import com.douyinpay.api.payments.nativepay.models.ApiQueryOrderByIdRequest;
import com.douyinpay.api.payments.nativepay.models.ApiQueryOrderByOutTradeNoRequest;
import com.douyinpay.api.payments.nativepay.models.ApiPrepayRequest;
import com.douyinpay.api.payments.nativepay.models.ApiPrepayResponse;
...
public class ApiNativePaymentsService {
    ...
    private ApiNativePaymentsService(DouyinpayClient douyinpayClient, DomainName domainName) {
    ...
    public static class Builder {
         ...
         * @return AppService
         */
        public ApiNativePaymentsService build() {
            return new ApiNativePaymentsService(douyinpayClient, domainName);
        }
    }
    ...
    public ApiPrepayResponse prepay(ApiPrepayRequest request) {
        String requestPath = "/v1/trade/transactions/native";
