...
public class ApiPrepayRequest {
   ...
   * 字段含义：支付者信息。
   * 格式规则：对象。
   * 业务规则：JSAPI 下单时用于传入用户 openid。
   * 示例：{"openid":"b8e6c6fe-fc06-573b-9987-deda78c15000"}
   */
  @SerializedName("payer")
  private ApiTransactionPayer payerInfo;
  ...
  public ApiTransactionPayer getPayerInfo() {
    return payerInfo;
  }

  public void setPayerInfo(ApiTransactionPayer payerInfo) {
