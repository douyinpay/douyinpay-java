package com.douyinpay.api.payments.h5;
 ...
 *
 * 官方文档：
 * - H5 下单：POST /v1/trade/transactions/h5
 *   https://pay.douyinpay.com/wiki/639fd48f17c2f3021d237f61/63f444f0b7d2f20202eaa928
 * - 关闭订单：POST /v1/trade/transactions/out-trade-no/{out_trade_no}/close
 *   https://pay.douyinpay.com/wiki/639fd48f17c2f3021d237f61/63f4450f0b970c02090700df
 ...
 *   https://pay.douyinpay.com/wiki/639fd48f17c2f3021d237f61/63f445410b970c0209070167
 */
public class ApiH5PaymentsService {
    ...
    private ApiH5PaymentsService(DouyinpayClient douyinpayClient, DomainName domainName) {
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public ApiH5PaymentsService.Builder domainName(DomainName domainName) {
            this.domainName = domainName;
            return this;
        }
         ...
         * @return Builder
         */
        public ApiH5PaymentsService.Builder douyinpayClient(DouyinpayClient douyinpayClient) {
            this.douyinpayClient = douyinpayClient;
            return this;
        }
         ...
         * @return AppService
         */
        public ApiH5PaymentsService build() {
            return new ApiH5PaymentsService(douyinpayClient, domainName);
        }
    }
    ...
    public ApiPrepayResponse prepay(ApiPrepayRequest request) {
        String requestPath = "/v1/trade/transactions/h5";
