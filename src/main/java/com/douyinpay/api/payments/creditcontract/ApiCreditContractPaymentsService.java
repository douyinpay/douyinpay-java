package com.douyinpay.api.payments.creditcontract;
...
public class ApiCreditContractPaymentsService {
    ...
    private ApiCreditContractPaymentsService(DouyinpayClient douyinpayClient, DomainName domainName) {
    ...
    public static class Builder {
         ...
         * @return AppService
         */
        public ApiCreditContractPaymentsService build() {
            return new ApiCreditContractPaymentsService(douyinpayClient, domainName);
        }
    }
    ...
    public ApiPrepayResponse prepay(ApiPrepayRequest request) {
        String requestPath = "/v1/trade/transactions/payscorecontractorder";
