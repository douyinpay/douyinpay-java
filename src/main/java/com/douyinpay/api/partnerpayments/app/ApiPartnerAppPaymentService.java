package com.douyinpay.api.partnerpayments.app;
...
import com.douyinpay.api.partnerpayments.app.model.ApiCloseOrderRequest;
import com.douyinpay.api.partnerpayments.app.model.ApiPrepayRequest;
import com.douyinpay.api.partnerpayments.app.model.ApiPrepayResponse;
import com.douyinpay.api.partnerpayments.app.model.ApiQueryOrderByIdRequest;
import com.douyinpay.api.partnerpayments.app.model.ApiQueryOrderByOutTradeNoRequest;
 ...
 *
 * 官方文档：
 * - APP 下单：POST /v1/trade/partner/transactions/app
 * https://partner.douyinpay.com/wiki/682c7a8e82b07604fd4deccb/6852bb1377f5de0546d4cdfe
 ...
 */
public class ApiPartnerAppPaymentService {
    ...
    private ApiPartnerAppPaymentService(DouyinpayClient douyinpayClient, DomainName domainName) {
    ...
    public static class Builder {
         ...
         * @return AppService
         */
        public ApiPartnerAppPaymentService build() {
            return new ApiPartnerAppPaymentService(douyinpayClient, domainName);
        }
    }
    ...
    public ApiPrepayResponse prepay(ApiPrepayRequest request) {
        String requestPath = "/v1/trade/partner/transactions/app";
