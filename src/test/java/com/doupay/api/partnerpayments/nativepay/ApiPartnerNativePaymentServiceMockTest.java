...
public class ApiPartnerNativePaymentServiceMockTest {

    @Test
    public void prepayMock() {
        ApiPartnerNativePaymentService apiNativePaymentsService = mock(ApiPartnerNativePaymentService.class);
        ...
        when(apiNativePaymentsService.prepay(request)).thenReturn(prepayResponse);
        ApiPrepayResponse response = apiNativePaymentsService.prepay(request);
        Assert.assertNotNull(response);
        Assert.assertEquals(prepayResponse.getCodeUrl(), response.getCodeUrl());
    }
    ...
    public void testCloseOrder() {
        ...
        }).when(apiNativePaymentsService).closeOrder(request);
    }
    ...
    public void queryOrderById(){
        ...
        when(apiNativePaymentsService.queryOrderById(request)).thenReturn(apiTransaction);
    ...
    public void testQueryOrderByOutTradeNo() {
        ...
        when(apiNativePaymentsService.queryOrderByOutTradeNo(request)).thenReturn(apiTransaction);
